...
from alcove.config import DEFAULT_PROFILES_DIRECTORY as DEFAULT_PROFILES_PATH  # noqa: F401
...
DEFAULT_PROFILES_MODULE = "alcove.profiles"
...
def _load_profile_tools() -> None:
    ...
    for tool_name in tool_names:
        ...
        if not loaded:
            shared_module_path = f"alcove.tools.{tool_name}"
            try:
                source = _try_load_tool(
                    tool_name,
